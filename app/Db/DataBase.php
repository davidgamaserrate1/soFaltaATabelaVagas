...
class DataBase{
        ...
        public function insertVagas($descricao_setor,  $descricao_cargo, $nome_empresa, $salario){
            //DADOS DA QUERY
          
 
            $query = 'INSERT INTO vagas (' .$descricao_setor. ','.  $descricao_cargo. ','.$nome_empresa. ','. $salario .')';
            
            //EXECUTA O INSERT
            $this->execute($query,array_values($descricao_setor,  $descricao_cargo, $nome_empresa, $salario));
        ...
        */
        ...
        public function selectTabela($fields, $table){ 
